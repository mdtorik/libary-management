<link rel="stylesheet" href="style.css">
  <nav class="main-header navbar navbar-expand text">
      <!-- Left navbar links -->
      <ul class="navbar-nav ">
        <li class="nav-item">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="home.php" class="nav-link  text">Home</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
          <a href="contact" class="nav-link text">Contact</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
          <button type="button" class=" btn btn-edit text" name="btnEdit" value="Add-Catagory" data-toggle="modal" data-target="#catagory-add" style="color:#0056B3;">Add-Catagory</button>        
        </li>
        <li class="nav-item d-none d-sm-inline-block">
          <a href="publishing-company" class="nav-link text">Publishir</a>
        </li>
      </ul>
      <!-- SEARCH FORM -->
